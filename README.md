...
- [x] Pre-OCR resolution gate & Upscaling — routes scans whose median MSER text-box height falls below 30px through cubic upscaling (minimum 5-box sample to avoid false positives), and outright rejects unrecoverable text < 8px, improving accuracy on low-resolution inputs.
